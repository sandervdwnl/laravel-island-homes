            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
                ...
                <div class="container my-4 pb-2 pl-8 xl:text-lg text-center">
                    ...
                    <div class="w-full max-w-lg mx-auto">
                        ...
                        <form action="admin/users/{{ $user->id }}" method="post" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                            @csrf
                            @method('put');
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" name="email" type="email" placeholder="example@mail.com" value="{{ $user->email }}">
                            </div>
                            <div class="mb-6">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="password">
                                    Password
                                </label>
                                <input class="shadow appearance-none border border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" name="password" type="password" placeholder="Min length: 8 characters">
                            </div>
                            <div class="mb-6">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="Admin">
                                    Admin Rights
                                </label>
                                <input class="shadow mr-2" id="is_admin" name="is_admin" type="checkbox" {{ $user->is_admin ? 'checked' : '' }}>
