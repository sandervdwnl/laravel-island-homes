        ...
        <div class=" mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-2xl px-12 font-bold w-full my-4">Add Property<span class="text-sm ml-2 text-gray-500 italic">All fields are required</span></h1>
                    ...
                    <div class="container my-4 xl:text-lg text-center">
                        ...
                        <div class="w-full mx-auto">
                            ...
                            <form action="../properties" method="post" class="bg-white shadow-md rounded mb-4 xl:mb-8 w-full">
                                @csrf
                                <div class="form-wrapper w-full flex flex-wrap px-8">
                                    ...
                                    <h2 class="text-center text-xl font-bold w-full my-4">Position<span class="text-sm ml-2 text-gray-500">Get with <a href="https://www.google.com/maps" target="_blank" class="text-blue-500">Google Maps</a> or <a href="https://www.latlong.net/" target="_blank" class="text-blue-500">Latlong</a> </span></h2>

                                    <div class="mb-4 xl:mb-8 w-full xl:w-1/2 px-4">
                                        <label class="block text-gray-500 text-base font-bold mb-2" for="latitude">
                                            Latitude
                                        </label>
                                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline" id="latitude" name="latitude" min="11.979144" max="18.145982" step="0.000001" type="number" placeholder="12.345678" value="{{ old('latitude') }}" required>
                                    </div>
                                    <div class="mb-4 xl:mb-8 w-full xl:w-1/2 px-4">
                                        <label class="block text-gray-500 text-base font-bold mb-2" for="longitude">
                                            Longitude
                                        </label>
                                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline" id="longitude" name="longitude" min="-68.440281" max="-62.966999" step="0.000001" type="number" placeholder="-12.345678" value="{{ old('longitude') }}" required>
                                    </div>
                                    ...
                                    <div class="mb-4 xl:mb-8 w-full xl:w-4/12 px-4">
                                        ...
                                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline" id="built_in" name="built_in" min="1900" step="1" type="number" placeholder="2010" value="{{ old('built_in') }}" required>
                                    </div>
                                    <div class="mb-4 xl:mb-8 w-full xl:w-4/12 px-4">
                                    ...
                                    <div class=" mb-4 xl:mb-8 mx-auto w-48">
                                        <input class="py-2 bg-green-300 hover:bg-green-200 text-white w-full font-bold rounded shadow" id="email" value="Submit Property" type="submit">
                                    </div>
                                </div>
                            </form>
                        </div>
